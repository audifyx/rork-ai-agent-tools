...
const styles = StyleSheet.create({
  ...
  statCard: { width: "31%" as any, backgroundColor: "rgba(255,255,255,0.03)", borderRadius: 16, padding: 14, borderWidth: 1, borderColor: "rgba(255,255,255,0.06)", alignItems: "center", gap: 6 },
  statVal: { fontSize: 22, fontWeight: "800" },
  statLabel: { fontSize: 10, color: Colors.textMuted },
  card: { backgroundColor: "rgba(255,255,255,0.03)", borderRadius: 16, padding: 16, borderWidth: 1, borderColor: "rgba(255,255,255,0.06)", marginTop: 12 },
  ...
  meter: { height: 4, backgroundColor: "rgba(255,255,255,0.06)", borderRadius: 2, overflow: "hidden" },
  ...
  actBorder: { borderBottomWidth: 1, borderBottomColor: "rgba(255,255,255,0.04)" },
  actIcon: { fontSize: 16 },
